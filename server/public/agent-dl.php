...
//
// 파일 출처는 둘로 나뉜다:
//   - 스크립트 2개: /var/www/agent-src (compose 가 ../agent 를 ro 로 마운트, git 추적).
...
//
// 무인증인 이유: 스크립트엔 비밀이 없고(토큰은 설치 시 사람이 대화형으로 넣는다), CA 는
//   공개 인증서(개인키 아님)다. 화이트리스트를 고정하므로 경로 traversal 은 불가능하다.
